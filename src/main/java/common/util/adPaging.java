...
public class adPaging {
	 ...
	 private int curPage;  //현재 페이지 번호
	   ...
	   public String toString() {
	      return "adPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount + ", totalPage="
	   ...
	   //총 게시글 수만 입력하는 생성자
	    public adPaging(int totalCount) {
	    ...
	    public adPaging(int totalCount,int curPage) {
	       setTotalCount(totalCount);
	       setCurPage(curPage);
	    ...
	    public adPaging(int totalCount,int curPage,int listCount) {
	       setTotalCount(totalCount);
	       setCurPage(curPage);
	    ...
	    public adPaging(int totalCount,int curPage,int listCount, int pageCount) {
	       setTotalCount(totalCount);
	       setCurPage(curPage);
	       setListCount(listCount);
