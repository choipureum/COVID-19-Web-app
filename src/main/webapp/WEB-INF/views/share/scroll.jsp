	...
	<c:forEach items="${list.nlist }" var="list" varStatus="i">
		...
		<li class="project_card reward_project_card">
			<div class="project_card_inner">
				<a href="/share/detail.do?shareDate=${list.SHAREDATE }&share_idx=${list.SHARE_IDX }"
					class="project_detail_link"> <span class="project_thumbnail"
				...
				<div class="project_card_info">
					...
					</span> <span class="txt_name">${list.MEMBER_ID }</span>
					</span> <span class="project_category"> <span class="screen_out">카테고리</span>
						${list.FEIELD }
					</span>
				</div>
