				...
				<div>
					...
					<div class="liveboard_layout">
						...
						<div class="liveNumOuter">
							<h2><a title="국내 환자현황 자세히 보기" href="/domesticPat.do">환자 현황<span class="livedate">(9.22. 00시 기준, 1.3 이후 누계)</span><span class="more">자세히</span></a></h2>							
							...
							<div class="liveNum_today_new">
								...
								<div class="datalist">
									<ul>
										<li>
											<span class="subtit">국내발생</span><span class="data">109</span>
										</li>
										<li>
											<span class="subtit">해외유입</span><span class="data">17</span>
										</li>
									</ul>
								</div>
							</div>
							<div class="liveNum">
								...
								<ul class="liveNum">
									<li>
										...
										<span class="num"><span class="mini">(누적)</span>22,783</span>
										<span class="before">전일대비 (+ 126)</span>
									</li>
									<li>
										<em class="sign">=</em>
										<strong class="tit">완치<br><span class="mini_tit">(격리해제)</span></strong>
										<span class="num">19,771</span>
										<span class="before">(+ 228)</span>
									</li>
									<li>
										<em class="sign">+</em>
										<strong class="tit">치료 중<br><span class="mini_tit">(격리 중)</span></strong>
										<span class="num">2,635</span>
										<span class="before">(- 107)</span>
						...
						<div class="liveToggleOuter">
							<div>
								...
								<div class="live_left">								
										...
										<div class="info_core">
											...
											<ul class="suminfo">
												<li>
													...
													<span class="num">2,206,365 건</span>
												</li>
												<li>
													<span class="tit">누적 검사완료수</span>
													<span class="num">2,180,962 건</span>
												</li>
												<li>
										...
										<div class="chart_d">
											...
											<div class="c_chart c_chart_is">
												...
												<div class="cc_figure">
													<p class="numinfo1">
														<span class="num_tit">검사중</span><br>
														<span class="num_rnum">25,403</span>
														<em class="mini">명</em><br>
														<span class="num_percentage">1.2 %</span>
													</p>
													<p class="numinfo2">
														<span class="num_tit">결과양성(확진)</span><br>
														<span class="num_rnum">22,783</span>
														<em class="mini">명</em><br>
														<span class="num_percentage">1.0 %</span>
													</p>
													<p class="numinfo3">
														<span class="num_tit">결과음성</span><br>
														<span class="num_rnum">2,158,179</span>
														<em class="mini">명</em><br>
														<span class="num_percentage">97.8 %</span>
													</p>
												</div>
											</div>
										</div>
									...
									<div class="liveWeek main_box_toggle">
										...
										<div class="info_week">
											...
											<div class="hdn">
												<table>
													<caption>09.16 ~ 09.22 주간환자동향표</caption>
													<thead>
														<tr>
															<th socpe="col">날짜</th>
													...
													<tbody>
													<th scope="row">09월16일</th><td>18</td><td>13132</td><td>218</td><td>837</td></tr><th scope="row">09월17일</th><td>32</td><td>13183</td><td>231</td><td>821</td></tr><th scope="row">09월18일</th><td>50</td><td>13233</td><td>212</td><td>802</td></tr><th scope="row">09월19일</th><td>26</td><td>13259</td><td>181</td><td>806</td></tr><th scope="row">09월20일</th><td>21</td><td>13280</td><td>121</td><td>808</td></tr><th scope="row">09월21일</th><td>109</td><td>13352</td><td>112</td><td>770</td></tr><th scope="row">09월22일</th><td>54</td><td>13406</td><td>109</td><td>748</td></tr>
													</tbody>
												</table>
											</div>
										</div>
								...
								<div class="live_right main_box_toggle">
									<h2><a title="시도별 확진환자 현황 자세히 보기" href="/detailPat.do">시도별 확진환자 현황<span class="livedate">( 09.22. 00시 기준, 1.3 이후 누계)</span><span class="more">자세히</span></a></h2>
									...
									<div class="regional_patient_status_A">
										<div class="rpsa_map">
											...
											<div class="rpsam_graph">
												<div id="main_maplayout">
													<button type="button" data-city="map_city1"><span class="name">서울</span><span class="num">4,904</span><span class="before">(+6)</span></button><button type="button" data-city="map_city2"><span class="name">부산</span><span class="num">369</span><span class="before">(+2)</span></button><button type="button" data-city="map_city3"><span class="name">대구</span><span class="num">7,120</span><span class="before">(+2)</span></button><button type="button" data-city="map_city4"><span class="name">인천</span><span class="num">865</span><span class="before">(+6)</span></button><button type="button" data-city="map_city5"><span class="name">광주</span><span class="num">485</span><span class="before">(0)</span></button><button type="button" data-city="map_city6"><span class="name">대전</span><span class="num">350</span><span class="before">(+3)</span></button><button type="button" data-city="map_city7"><span class="name">울산</span><span class="num">141</span><span class="before">(0)</span></button><button type="button" data-city="map_city8"><span class="name">세종</span><span class="num">70</span><span class="before">(0)</span></button><button type="button" data-city="map_city9"><span class="name">경기</span><span class="num">4,089</span><span class="before">(+37)</span></button><button type="button" data-city="map_city10"><span class="name">강원</span><span class="num">217</span><span class="before">(0)</span></button><button type="button" data-city="map_city11"><span class="name">충북</span><span class="num">154</span><span class="before">(+3)</span></button><button type="button" data-city="map_city12"><span class="name">충남</span><span class="num">463</span><span class="before">(+6)</span></button><button type="button" data-city="map_city13"><span class="name">전북</span><span class="num">114</span><span class="before">(+8)</span></button><button type="button" data-city="map_city14"><span class="name">전남</span><span class="num">167</span><span class="before">(0)</span></button><button type="button" data-city="map_city15"><span class="name">경북</span><span class="num">1,502</span><span class="before">(+5)</span></button><button type="button" data-city="map_city16"><span class="name">경남</span><span class="num">281</span><span class="before">(+4)</span></button><button type="button" data-city="map_city17"><span class="name">제주</span><span class="num">58</span><span class="before">(+2)</span></button><button type="button" data-city="map_city18"><span class="name">검역</span><span class="num">1,434</span><span class="before">(+2)</span></button>
										...
										<div class="rpsa_detail">
											<div>
												...
												<div class="open" id="mapAll"><h4 class="cityname">전국</h4><div class="mapview"><div class="c_chart c_chart_rpr_A"><div class="cc_graph"><canvas id="regional_patient_ratio_A"></canvas></div></div><div class="citychart"><p class="allcity_info1">대구 31.3 %</p><p class="allcity_info2">기타 22.7 %</p><p class="allcity_info3">서울 21.5 %</p><p class="allcity_info4">경기 17.9 %</p><p class="allcity_info5">경북 6.6 %</p></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">22,783</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+126)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">2,635</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">19,771</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">377</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">43.94</span><em>명</em></div></li></ul></div></div><div id="map_city1"><h4 class="cityname">서울</h4><div class="mapview"><div class="citychart"><p class="citytit">21.52%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="21.52"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">4,904</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+46)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">1,017</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">3,481</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">46</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">50.38</span><em>명</em></div></li></ul></div></div><div id="map_city2"><h4 class="cityname">부산</h4><div class="mapview"><div class="citychart"><p class="citytit">1.62%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="1.62"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">369</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+2)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">54</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">311</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">4</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">10.82</span><em>명</em></div></li></ul></div></div><div id="map_city3"><h4 class="cityname">대구</h4><div class="mapview"><div class="citychart"><p class="citytit">31.25%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="31.25"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">7,120</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+2)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">69</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">6,859</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">191</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">292.22</span><em>명</em></div></li></ul></div></div><div id="map_city4"><h4 class="cityname">인천</h4><div class="mapview"><div class="citychart"><p class="citytit">3.8%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="3.8"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">865</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+6)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">119</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">738</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">8</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">29.26</span><em>명</em></div></li></ul></div></div><div id="map_city5"><h4 class="cityname">광주</h4><div class="mapview"><div class="citychart"><p class="citytit">2.13%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="2.13"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">485</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(0)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">82</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">400</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">3</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">33.29</span><em>명</em></div></li></ul></div></div><div id="map_city6"><h4 class="cityname">대전</h4><div class="mapview"><div class="citychart"><p class="citytit">1.54%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="1.54"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">350</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+3)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">60</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">287</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">3</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">23.74</span><em>명</em></div></li></ul></div></div><div id="map_city7"><h4 class="cityname">울산</h4><div class="mapview"><div class="citychart"><p class="citytit">0.62%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="0.62"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">141</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(0)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">32</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">108</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">1</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">12.29</span><em>명</em></div></li></ul></div></div><div id="map_city8"><h4 class="cityname">세종</h4><div class="mapview"><div class="citychart"><p class="citytit">0.31%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="0.31"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">70</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(0)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">6</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">64</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">0</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">20.45</span><em>명</em></div></li></ul></div></div><div id="map_city9"><h4 class="cityname">경기</h4><div class="mapview"><div class="citychart"><p class="citytit">17.95%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="17.95"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">4,089</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+37)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">734</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">3,296</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">59</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">30.86</span><em>명</em></div></li></ul></div></div><div id="map_city10"><h4 class="cityname">강원</h4><div class="mapview"><div class="citychart"><p class="citytit">0.95%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="0.95"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">217</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(0)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">26</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">188</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">3</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">14.09</span><em>명</em></div></li></ul></div></div><div id="map_city11"><h4 class="cityname">충북</h4><div class="mapview"><div class="citychart"><p class="citytit">0.68%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="0.68"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">154</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+3)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">27</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">126</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">1</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">9.63</span><em>명</em></div></li></ul></div></div><div id="map_city12"><h4 class="cityname">충남</h4><div class="mapview"><div class="citychart"><p class="citytit">2.03%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="2.03"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">463</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+6)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">126</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">335</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">2</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">21.81</span><em>명</em></div></li></ul></div></div><div id="map_city13"><h4 class="cityname">전북</h4><div class="mapview"><div class="citychart"><p class="citytit">0.5%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="0.5"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">114</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+8)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">35</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">79</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">0</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">6.27</span><em>명</em></div></li></ul></div></div><div id="map_city14"><h4 class="cityname">전남</h4><div class="mapview"><div class="citychart"><p class="citytit">0.73%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="0.73"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">167</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(0)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">67</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">100</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">0</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">8.96</span><em>명</em></div></li></ul></div></div><div id="map_city15"><h4 class="cityname">경북</h4><div class="mapview"><div class="citychart"><p class="citytit">6.59%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="6.59"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">1,502</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+5)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">40</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">1,407</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">55</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">56.41</span><em>명</em></div></li></ul></div></div><div id="map_city16"><h4 class="cityname">경남</h4><div class="mapview"><div class="citychart"><p class="citytit">1.23%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="1.23"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">281</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+4)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">35</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">246</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">0</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">8.36</span><em>명</em></div></li></ul></div></div><div id="map_city17"><h4 class="cityname">제주</h4><div class="mapview"><div class="citychart"><p class="citytit">0.25%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="0.25"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">58</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+2)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">13</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">45</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">0</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">8.65</span><em>명</em></div></li></ul></div></div><div id="map_city18"><h4 class="cityname">검역</h4><div class="mapview"><div class="citychart"><p class="citytit">6.29%<br /><span class="tit_sub">전국대비 확진자 비율</span></p></div><div class="regional_incidence_ratio" data-percentage="6.29"><svg viewbox="0 0 100 100"><path x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path><path class="rir_path" x=0 y=0 d="M50 10 a 40 40 0 0 1 0 80 a 40 40 0 0 1 0 -80"></path></svg><div class="rir_text"><div><span>전국대비 확진자 비율</span><p class="rir_figure"></p></div></div></div><ul class="cityinfo"><li><div><span class="tit">누적 확진환자</span></div><div><span class="num">1,434</span><em>명</em></div></li><li><div><span class="sub_tit red">전일 대비 증감</span></div><div><span class="sub_num red">(+2)</span></div></li><li><div><span class="tit">격리중</span></div><div><span class="num">93</span><em>명</em></div></li><li><div><span class="tit">누적 격리해제</span></div><div><span class="num">1,341</span><em>명</em></div></li><li><div><span class="tit">사망자</span></div><div><span class="num">0</span><em>명</em></div></li><li><div><span class="sub_tit">10만명당 발생률</span></div><div><span class="num">-</span><em>명</em></div></li></ul></div></div>
											</div>
										</div>
									</div>
								</div>
  ...
  gtag('config', 'UA-159814989-1');
	...
	<script>
		$(function(){
			...
			IS_data = {
			    label: ["결과음성", "검사중", "결과양성"],
			    figure: [parseInt("2,158,179".replace(",")), parseInt("25,403".replace(",")), parseInt("22,783".replace(","))]
			};
			
			//전국 파이
			RPR_A_MAIN_data = {
				label : ["대구","기타","서울","경기","경북"],
				figure : [7120,,9257,4904,1502]
			};
			
			//WPS
			WPS_data = {
			    date: ["09.16","09.17","09.18","09.19","09.20","09.21","09.22"],
			    complete_day:[413,197,263,389,432,233,228],
			    confirm_day:[136,121,109,106,113,153,116],
