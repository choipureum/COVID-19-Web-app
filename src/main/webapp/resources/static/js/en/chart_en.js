...
//var IS_data = {
//    label: ['Negative Results', 'In Progress', 'Positive Results(Confirmed Cases)'],
    ...
    new Chart(document.getElementById('inspect_status'), {
        ...
        data: {
            ...
            datasets: [
                {
                    data: IS_data.figure,
                    backgroundColor: ['#3ca8bb', '#ededed', '#105a67']
                }
            ]
        },
        options: {
    ...
    new Chart(document.getElementById('weekly_patient_status'), {
        ...
        data: {
            ...
            datasets: [
                {
                    type: 'line',
                    data: WPS_data.cure_total,
                    pointStyle: 'rect',
                    pointRadius: '4',
                    pointBackgroundColor: '#28afb4',
                    pointBorderColor: '#28afb4',
                    borderColor: '#28afb4',
                    borderWidth: 2,
                    fill: false,
                    yAxisID: 'yAxes_right'
                ...
                {
                    type: 'line',
                    data: WPS_data.complete_total,
                    pointStyle: 'triangle',
                    pointRadius: '4',
                    pointBackgroundColor: '#2a5ebc',
                    pointBorderColor: '#2a5ebc',
                    borderColor: '#2a5ebc',
                    borderWidth: 2,
                    fill: false,
                    yAxisID: 'yAxes_right'
...
var RPSBaseData = [];
//var RPSBaseData = [
//	{name: 'Seoul', count: 488},
//	{name: 'Busan', count: 122},
//	{name: 'Daegu', count: 6725},
//	{name: 'Incheon', count: 73},
//	{name: 'Gwangju', count: 25},
//	{name: 'Daejeon', count: 36},
//	{name: 'Ulsan', count: 40},
//	{name: 'Sejong', count: 46},
//	{name: 'Gyeonggi-do', count: 516},
//	{name: 'Gangwon-do', count: 39},
//	{name: 'Chungcheongbuk-do', count: 44},
//	{name: 'Chungcheongnam-do', count: 133},
//	{name: 'Jeollabuk-do', count: 14},
//	{name: 'Jeollanam-do', count: 14},
//	{name: 'Gyeongsangbuk-do', count: 1304},
//	{name: 'Gyeongsangnam-do', count: 106},
//	{name: 'Jeju', count: 9},
//	{name: 'Lazaretto', count: 242}
//	];
...
var RPR_A_data = {};
//var RPR_A_data = {
//    label: ['Daegu\n', 'Gyeongsang\nbuk-do\n', 'Others', 'Gyeonggi-do', 'Seoul'],
//    figure: [6725,1304,943,516,488]
//};
            ...
            datasets: [
                {
                    ...
                    backgroundColor: ['#ee5b59', '#f2999a', '#fce1e1', '#cb2828', '#870000']
                }
            ]
        },
        options: {
...
var RPR_B_data = {};
//var RPR_B_data = {
//    label: ['Daegu', 'Others', 'Gyeongsangbuk-do'],
...
var GIR_data = {};
//var GIR_data = {
//    label: ['Shincheonji-\nrelated', 'Others', 'Sporadic incidents'],
                    ...
                    labels: {
                        inside: {
                            ...
                            offset: function(a, b) {
                            	...
                            	if (a.dataIndex === (a.dataset.data.length - 1)) {
                            		return 24;
                            ...
                            formatter: function(a, b) {
                            	if (b.dataIndex < 3) {
                            		return b.chart.data.labels[b.dataIndex] + "\n" + a + " / " + ((a * 100) / TC_total).toFixed(i) + ' %';
                            	} else {
                            		return b.chart.data.labels[b.dataIndex] + " " + a + " / " + ((a * 100) / TC_total).toFixed(i) + ' %';
                            	}
                            }
                        }
                    }
